#!/bin/bash
# Coded by: github.com/free-fire-hacker
# Instagram: @_el_primo_stars_ 'store;exit 1' 2
...
printf "\n"
printf "\e[1;77m\e[45m  Instagram Brute Forcer v1.2 Author: @free-fire-hacker(Github/IG)   \e[0m\n"
printf "\n"
}
